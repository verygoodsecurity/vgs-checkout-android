...
object Constants {
    ...
    const val VALID_CARD_NUMBER_AMEX = "370000000000002"
    const val VALID_CARD_NUMBER_MASTERCARD = "5500000000000004"
    const val FORMATTED_CARD_NUMBER = "4111 1111 1111 1111"
    const val INVALID_CARD_NUMBER = "0000000000000000"
    const val VALID_SECURITY_CODE_AMEX = "1111"
    const val VALID_EXP_DATE = "10/33"
