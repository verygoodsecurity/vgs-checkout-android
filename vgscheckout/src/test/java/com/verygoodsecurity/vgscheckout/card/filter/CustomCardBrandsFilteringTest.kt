...
class CustomCardBrandsFilteringTest {
    ...
    fun test_detect_custom_brand() {
        val c1 = CardBrand("^123", "VG_Search", drawableResId = R.drawable.vgs_checkout_ic_card_front_preview_dark)
        ...
        assertEquals(testItem1?.resId, R.drawable.vgs_checkout_ic_card_front_preview_dark)
    }
    ...
    fun test_detect_custom_brand_mask() {
        ...
        assertEquals(resId, R.drawable.vgs_checkout_ic_card_front_preview_dark)
    }
