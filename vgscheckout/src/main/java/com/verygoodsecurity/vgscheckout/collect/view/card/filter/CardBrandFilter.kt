...
import com.verygoodsecurity.vgscheckout.collect.util.extension.except
import com.verygoodsecurity.vgscheckout.collect.util.extension.toCardBrands
...
/** @suppress */
internal class CardBrandFilter(private var divider: String? = DEFAULT_DIVIDER) : MutableCardFilter {
